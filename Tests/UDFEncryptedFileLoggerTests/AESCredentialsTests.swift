...
struct AESCredentialsTests {
    ...
    func keyWithKeySize(key: String, isValid: Bool) throws {
    ...
    func keyWithBase64Text(key: String, isValid: Bool) throws {
        let validIV = AESCipher.Credentials.randomIV()
    ...
    func initializeAESIV(iv: String, isValid: Bool) throws {
